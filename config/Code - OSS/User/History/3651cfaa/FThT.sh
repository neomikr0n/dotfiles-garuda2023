...
kitty --config NONE --title spotify-cava --hold cava &
kitty --config NONE --title spotify-timer --hold timer -l 88 '| lolcat -a -d 1 -s 999 -t' &
kitty --config NONE --title spotify-glava --hold glava & disown &
