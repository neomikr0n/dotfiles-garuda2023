...
Please use [*genSMBIOS*](https://github.com/corpnewt/GenSMBIOS/) [download](https://github.com/corpnewt/GenSMBIOS/archive/refs/heads/master.zip) for generate values for above itens.
<br>
```
