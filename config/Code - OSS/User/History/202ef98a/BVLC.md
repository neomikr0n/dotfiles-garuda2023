...
#### $scriptsDir = ~/.dotfiles/bin#### $soundsDir = ~/.config/hypr/sounds      #TODO: move to /dotfiles/share#### $picsDir = ~/Pictures/#### $configDir = ~/.config/hypr/configs/#### $mainMod = SUPER#### $triMod = SUPER CTRL ALT#### $files = dolphin#### $browser = firedragon#### $music = spotify#### $term = foot#### $menu = $scriptsDir/menu#### $volume = $scriptsDir/volume#### $exit = $scriptsDir/exit#### $screenshot = $scriptsDir/grimblast#### $colorpicker = $scriptsDir/hyprpicker.sh#### $wofi_beats = $scriptsDir/wofi-beats#### $test = notify-send --urgency=normal --icon=firedragon -t 555 -e "test..." "⌛0% [ █ █ █ █ █ █ █ ] 100%"
