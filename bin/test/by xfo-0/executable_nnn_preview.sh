...
WIDTH="$NNN_PREVIEW_WIDTH" # Width of the preview pane (number of fitting characters)
HEIGHT="$NNN_PREVIEW_HEIGHT"  # Height of the preview pane (number of fitting characters)
X="$NNN_PREVIEW_X"  # X coordinate of the preview pane
Y="$NNN_PREVIEW_Y" # Y coordinate of the preview pane
